...
public class ConnectionPool {
    ...
    //连接池
    private static MyConnection[] connectionList = new MyConnection[5];
    //连接池对应状态   占用1/释放0/空置-1
    private static byte[] connectionBitMap = new byte[5];
    //连接池存量
    ...
    //释放connection
    public static void freeConnection(MyConnection myConnection){
